...
@Component({
  selector: 'app-expatriation-news',
  templateUrl: './expatriation-news.component.html',
  styleUrls: ['./expatriation-news.component.scss']
})
export class ExpatriationNewsComponent implements OnInit {
  public title: string = 'expatriation';
