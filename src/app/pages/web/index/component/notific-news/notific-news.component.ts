...
@Component({
  selector: 'app-notific-news',
  templateUrl: './notific-news.component.html',
  styleUrls: ['./notific-news.component.scss']
})
export class NotificNewsComponent implements OnInit {
